...
GAME_LOOP_INTERVAL  = 0.001       # 降低循環等待，充分利用 RTX 5090 性能
SHOW_DEBUG             = True     # 默認開啟 Debug 窗口
DEBUG_OVERLAY_INTERVAL = 0.033    # 恢復到 ~30FPS 刷新頻率，保證流暢度
...
REGION_X          = 100            # ★ 轨道X轴搜索/锁定半径 (100->45), 防止误检相邻轨道
